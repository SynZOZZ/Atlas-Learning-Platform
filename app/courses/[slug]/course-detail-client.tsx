...
export default function CourseDetailClient({ slug }: { slug: string }) {
  ...
  return <main className="course-detail">
    ...
    <footer className="site-footer shell"><Link className="academy-brand" href="/" aria-label="4Z Academy home"><img src="/assets/4z-academy-logo.png" alt="4Z Academy" /></Link><p>© 2026 {publicConfig.name}</p></footer>
  </main>;
}
